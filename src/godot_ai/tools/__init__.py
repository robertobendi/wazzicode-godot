...
tool search. Core tools (always loaded: godot_orient, session_activate,
editor_state, scene_get_hierarchy, node_get_properties — see `CORE_TOOLS`
in domains.py) omit it.
